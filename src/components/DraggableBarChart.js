...
export default class DraggableBarChart extends React.Component {
  ...
  initExplanationContainer() {
    ...
    const explanationContainer = this.mainGroup.append('g')
      ...
      .attr('transform', d => `translate(100, ${scaleY(d.value) - 92})`)
  ...
  animateExplanationLabel() {
    ...
    explanationContainer.transition()
      ...
      .attr('transform', d => `translate(100, ${scaleY(d.random1) - 92})`)
      .transition()
      .duration(durations.anim2)
      .attr('transform', d => `translate(100, ${scaleY(d.random2) - 92})`)
      .transition()
    ...
    arrow.transition()
      .duration(1000)
      .attr('transform', 'translate(20,90) scale(0.7)')
    arrow.transition()
